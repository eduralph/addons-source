...
Run with::
    ...
    python3 -m pytest Form/tests/test_form_validator.py -v
"""
...
class TestSplitFamilyTitle(unittest.TestCase):
    ...
    def test_multiple_separators_only_split_once(self):
        self.assertEqual(
            split_family_title("A/B/C"), ("A", "B/C")
        )
...
class TestValidateFormDomErrors(unittest.TestCase):
    ...
    def test_form_missing_id_attribute(self):
        dom = _dom_from_string(
            "<forms><form type='Census' title='x'/></forms>"
        )
        errors = validate_form_dom(dom)
    ...
    def test_form_missing_title_attribute(self):
        ...
        errors = validate_form_dom(dom)
        self.assertTrue(
            any("missing required attribute 'title'" in e for e in errors)
        )
    ...
    def test_form_missing_type_attribute(self):
        ...
        errors = validate_form_dom(dom)
        self.assertTrue(
            any("missing required attribute 'type'" in e for e in errors)
        )
